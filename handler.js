...
module.exports = {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API('hardianto', '/api/welcome3', {
                                ...
                                bg: 'https://telegra.ph/file/ea3a3edf9f08d3bc8a427.jpg',
   ...
   await conn.sendButtonDoc(id, text, wm, action == 'add' ? 'selamat datang' : 'sampai jumpa', action === 'add' ? '.intro' : 'the.sad.boy01', fgclink,{
  contextInfo: { externalAdReply :{
    ...
    async groupsUpdate(groupsUpdate, fromMe, m) {
        ...
        for (let groupUpdate of groupsUpdate) {
            ...
            //console.log('=============\n\ngroupsUpdate \n\n============\n\n' + await groupUpdate)
            if (!text) continue
            await this.sendButton(id, text, wm, 'Matikan Fitur', `.off detect`, ftroli, { contextInfo: { mentionedJid: this.parseMention(text) }, mentions: await this.parseMention(text) })
